...
import { navigatorConfig, NavigatorConfigType } from './navigator/config';
...
const linking = {
    prefixes: ['https://vuadungcu.com', 'http://vuadungcu.com', 'vdcapp://'],
    config: getConfigLinking(),

    async getInitialURL() {
        // console.log('getConfigLinking() ', JSON.stringify(getConfigLinking()));
        ...
        if (url != null) {
            ...
            // xu ly deeplink trong home screen
            // return url;
        }
    ...
    //     console.log('config config deeplink ', JSON.stringify(config));
    // },
